...
const ENTRIES = [
  ...
  E("ACE HOTEL", "culture", 6.5, 6.0, 6.5, 7.5, 6.5, "Hotel group founded in Seattle in 1999 that helped define the design-led boutique hotel, embedding local art, music and culture into its properties.", "https://acehotel.com", "Ace Hotel"),

  /* ---- DESIGN ---- */
  E("LEGO", "design", 8.5, 8.0, 9.0, 8.5, 9.5, "Danish family-owned toy company founded in 1932, maker of the world's best-selling construction toy and a long-term investor in sustainable materials and learning through play.", "https://www.lego.com", "Lego"),
  ...
  E("VITSŒ", "design", 8.0, 6.5, 8.5, 7.5, 8.0, "Furniture company founded in 1959 to produce Dieter Rams' designs, including the 606 Universal Shelving System, built around an ethos of fewer, better things that last for generations.", "https://www.vitsoe.com", "Vitsœ"),
  E("FIGMA", "design", 8.0, 8.0, 7.5, 7.0, 8.0, "Browser-based collaborative design platform founded in 2012, which became the standard tool for interface design. Listed publicly in 2025 after Adobe's proposed acquisition was abandoned.", "https://www.figma.com", "Figma"),
  E("ABLETON", "design", 7.5, 7.0, 8.0, 7.0, 8.5, "Berlin music software company founded in 1999 by musicians, maker of Ableton Live, a digital audio workstation built for performance as much as production, and the Push instrument.", "https://www.ableton.com", "Ableton"),
  ...
  E("ANDURIL", "deeptech", 8.0, 8.5, 6.0, 7.5, 6.0, "American defence technology company founded by Palmer Luckey in 2017, building autonomous systems and the Lattice software platform for military use.", "https://www.anduril.com", "Anduril Industries"),
  ...
  E("INTERNET ARCHIVE", "education", 8.5, 8.5, 9.5, 6.0, 8.0, "San Francisco non-profit digital library founded by Brewster Kahle in 1996, home to the Wayback Machine and hundreds of billions of archived web pages, books, films and recordings.", "https://archive.org", "Internet Archive"),
  ...
  E("DUOLINGO", "education", 7.5, 7.5, 8.0, 9.0, 8.0, "Pittsburgh language-learning company founded in 2011 by Luis von Ahn, whose free gamified app became the world's most downloaded education app.", "https://www.duolingo.com", "Duolingo"),
  ...
  E("TONY'S CHOCOLONELY", "finance", 8.0, 7.0, 9.0, 8.5, 8.5, "Dutch chocolate company founded in 2005 by journalists investigating slavery in cocoa. On a mission to end exploitation in the industry, with a fully traceable bean-to-bar supply chain.", "https://tonyschocolonely.com", "Tony's Chocolonely"),
  E("STRIPE", "finance", 8.0, 8.5, 7.5, 7.5, 8.0, "Irish-American payments company founded by Patrick and John Collison in 2010, providing the financial infrastructure behind millions of online businesses. Funds carbon removal through Stripe Climate and Frontier.", "https://stripe.com", "Stripe, Inc."),
  E("Y COMBINATOR", "finance", 8.0, 8.5, 7.5, 7.5, 7.5, "Silicon Valley startup accelerator founded by Paul Graham and partners in 2005, which seeded Airbnb, Stripe, Dropbox and Reddit and reshaped how early-stage companies are built.", "https://www.ycombinator.com", "Y Combinator"),
  E("KICKSTARTER", "finance", 7.5, 7.5, 8.0, 7.0, 7.5, "New York crowdfunding platform founded in 2009 and structured as a public benefit corporation, which has channelled billions of dollars in pledges to creative projects.", "https://www.kickstarter.com", "Kickstarter"),
