...
const ENTRIES = [
  E("ANTHROPIC", "science", "aa", "American AI safety company founded in 2021 by former OpenAI researchers, and the developer of the Claude family of AI models. Its research focuses on making AI systems reliable, interpretable and steerable.", "Anthropic treats safety as architecture, codifying principles into the structures and research that make powerful AI trustworthy, ambition built to hold under pressure.", "https://www.anthropic.com", "Anthropic", "anthropicai"),
  ...
  E("ØRSTED", "science", "oi", "Danish energy company, formerly the oil and gas firm DONG Energy, which transformed itself into the world's largest developer of offshore wind power.", "Ørsted reinvented itself from fossil fuels to offshore wind, living proof that even the heaviest legacy can choose a positive future and build it.", "https://orsted.com", "Ørsted (company)", "orsted"),
  ...
  E("WOLFRAM RESEARCH", "science", "gl", "American computational software company founded by Stephen Wolfram in 1987, creator of Mathematica and the Wolfram Language, and home to the Wolfram Physics Project, which explores emergence and complexity from simple computational rules.", "Wolfram built his own field rather than compete inside anyone else's, staying independent for four decades so that one mind's singular theory of everything could pull the whole of physics toward it.", "https://www.wolfram.com", "Wolfram Research", "wolframresearch"),
  E("ECOSIA", "science", "oi", "Berlin-based search engine founded in 2009 that uses its advertising profits to fund tree planting, with more than 200 million trees planted across the world to date.", "Ecosia turned an everyday action into reforestation, a quietly defiant insistence that the tools we already use can be redirected toward a better future.", "https://www.ecosia.org", "Ecosia", "ecosia"),
  ...
  E("MIT MEDIA LAB", "science", "aa", "Interdisciplinary research laboratory at MIT, founded in 1985 and known for work spanning wearable computing, learning technology, robotics and digital interfaces.", "The Media Lab is a structure built to invent the future across disciplines, the architecture that turns wild ambition into working prototypes.", "https://www.media.mit.edu", "MIT Media Lab", "mitmedialab"),
  E("FRANCIS CRICK INSTITUTE", "science", "dt", "Europe's largest biomedical laboratory under one roof, opened in London in 2016, where more than 2,000 scientists study the biology of health and disease.", "The Crick pursues the long, patient science of how life works, the foundational biology whose payoff arrives in medicine decades downstream.", "https://www.crick.ac.uk", "Francis Crick Institute", "thecrick"),
  ...
  E("V&A", "culture", "cg", "London's Victoria and Albert Museum, founded in 1852, is the world's largest museum of applied arts, decorative arts and design, with a collection spanning 5,000 years.", "The V&A is a vast, generous conduit for design and creativity, infrastructure that lets the story of human making flow to everyone who walks in.", "https://www.vam.ac.uk", "Victoria and Albert Museum", "vamuseum"),
  ...
  E("FACTORY INTERNATIONAL", "culture", "cg", "Manchester arts organisation behind the Manchester International Festival and Aviva Studios, a landmark venue for commissioning new work that opened in 2023.", "Factory International built a permanent home for ambitious culture in Manchester, infrastructure designed to let artists and audiences connect at a scale the city never had.", "https://factoryinternational.org", "Factory International", "factoryintl"),
  ...
  E("WARP RECORDS", "culture", "cg", "Independent label born in Sheffield in 1989, home to Aphex Twin, Boards of Canada and Autechre, which defined the sound of electronic listening music.", "Warp is infrastructure for the future of music, a label that gives the most adventurous artists somewhere to go and lets their ideas flow into the wider culture.", "https://warp.net", "Warp (record label)", "warprecords"),
  E("NINJA TUNE", "culture", "cg", "Independent London label founded by Coldcut in 1990, an early leader on sustainability in music with a solar-powered headquarters and support for the Music Climate Pact.", "Ninja Tune has spent decades as a conduit for independent music, a label that powers the flow of new sound rather than chasing the centre.", "https://ninjatune.net", "Ninja Tune", "ninjatune"),
  ...
  E("IKEA", "art", "gl", "Swedish furniture retailer founded by Ingvar Kamprad in 1943, whose flat-pack democratic design made good furniture affordable worldwide. Investing heavily in circular and renewable operations.", "IKEA made considered design gravitational at planetary scale, building a world so coherent and so clearly its own that it became the default rather than a competitor.", "https://www.ikea.com", "IKEA", "ikea"),
  ...
  E("IDEO", "art", "aa", "Global design consultancy formed in Palo Alto in 1991, which popularised design thinking and human-centred design across products, services and organisations.", "IDEO codified human-centred design into a method the world could use, turning a way of thinking into durable architecture for how things get made.", "https://www.ideo.com", "IDEO", "ideo"),
  ...
  E("NEXUS STUDIOS", "art", "gl", "London and Los Angeles animation and innovation studio founded in 2000, creating award-winning films, immersive experiences and augmented reality for brands including Apple, Google and Nike.", "Nexus draws the world's most ambitious creative work through the depth of its craft, a studio whose mastery is its own form of gravity.", "https://nexusstudios.com", "Nexus Studios", "nexusstudios"),
  ...
  E("NAOSHIMA", "art", "gl", "Japanese island in the Seto Inland Sea reborn as a contemporary art destination through the Benesse Art Site, home to Tadao Ando museums and works by James Turrell and Yayoi Kusama.", "Naoshima turned a remote island into a place people cross the world to reach, gravitational not through promotion but through the sheer conviction of its vision.", "https://benesse-artsite.jp", "Naoshima", "benesse_artsite"),
  ...
  E("ZKM", "culture", "cg", "German Centre for Art and Media in Karlsruhe, founded in 1989, a leading museum and research institution at the meeting point of art, science and digital technology.", "ZKM has spent decades as infrastructure for art and technology, a conduit that lets the conversation between the two flow and endure.", "https://zkm.de", "ZKM Center for Art and Media", "zkmkarlsruhe"),
