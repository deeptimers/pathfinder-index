...
const ENTRIES = [
  E("ANTHROPIC", "science", "aa", "American AI safety company founded in 2021 by former OpenAI researchers, and the developer of the Claude family of AI models. Its research focuses on making AI systems reliable, interpretable and steerable.", "Pathfinder via Ambition Architecture. Anthropic treats safety as architecture, codifying principles into the structures and research that make powerful AI trustworthy, ambition built to hold under pressure.", "https://www.anthropic.com", "Anthropic", "anthropicai"),
  E("DEEPMIND", "science", "dt", "British-American AI laboratory founded in London in 2010 and now part of Google. Its AlphaFold system predicted the structures of over 200 million proteins, a landmark contribution to biology.", "Pathfinder via Deep Time Thinking. Solving intelligence itself is the longest game there is, and DeepMind plays it patiently, treating the deepest scientific questions as the work of decades rather than product cycles.", "https://deepmind.google", "Google DeepMind", "googledeepmind"),
  E("NVIDIA", "science", "aa", "American technology company founded in 1993 whose graphics processors became the standard hardware for training modern AI systems, making it one of the most valuable companies in the world.", "Pathfinder via Ambition Architecture. Nvidia built the foundational layer the entire AI era runs on, the architecture beneath everyone else's ambition, turning a hardware company into critical infrastructure.", "https://www.nvidia.com", "Nvidia", "nvidia"),
  E("HUGGING FACE", "science", "aa", "American-French company that hosts the leading open platform for sharing machine learning models and datasets. Its open-source libraries, including Transformers, are foundational to modern AI development.", "Pathfinder via Ambition Architecture. Hugging Face built the open architecture for modern machine learning, the shared structure on which a whole field's ambition now rests.", "https://huggingface.co", "Hugging Face", "huggingface"),
  E("CENTER FOR HUMANE TECHNOLOGY", "science", "oi", "American non-profit founded in 2018 by former tech insiders, behind the film The Social Dilemma, working to realign technology with humanity's wellbeing and counter the attention-extraction and manipulation built into modern platforms.", "Pathfinder via The Optimism Imperative. The Center for Humane Technology refuses the techno-dystopian default, insisting that technology can serve human flourishing and doing the work to realise it, optimism as active defiance.", "https://www.humanetech.com", "Center for Humane Technology", "humanetech"),
  E("RUNWAY", "science", "aa", "New York research company building generative AI tools for video and film, including the Gen series of video models. Its tools have been used in feature films and music videos.", "Pathfinder via Ambition Architecture. Runway is building the tools that turn the ambition of a new visual era into something creators can actually use, architecture for the future of making images.", "https://runwayml.com", "Runway (company)", "runwayml"),
  E("SPACEX", "science", "dt", "American aerospace company founded by Elon Musk in 2002 with the stated goal of making humanity multiplanetary. Developed the first orbital-class reusable rockets and operates the Starlink satellite network.", "Pathfinder via Deep Time Thinking. Making life multiplanetary is the deepest time horizon a company can hold, an insurance policy on consciousness measured in centuries, and nobody dramatises the long arc of human ambition more vividly.", "https://www.spacex.com", "SpaceX", "spacex"),
  E("NASA", "science", "dt", "The United States' civil space agency, founded in 1958 and responsible for the Apollo Moon landings, the Space Shuttle, the James Webb Space Telescope and the Artemis programme returning humans to the Moon.", "Pathfinder via Deep Time Thinking. NASA thinks in epochs, sending instruments on journeys that outlast the careers of the people who build them, and treating the expansion of human knowledge as a multigenerational duty.", "https://www.nasa.gov", "NASA", "nasa"),
  E("ESA", "science", "dt", "The intergovernmental space agency of more than 20 European states, founded in 1975 and headquartered in Paris. Its work spans Earth observation, the Ariane launchers and deep-space science missions such as Juice and Gaia.", "Pathfinder via Deep Time Thinking. ESA builds for missions that report back decades after launch, holding a patient, civilisational view of what it means to understand our place in the cosmos.", "https://www.esa.int", "European Space Agency", "europeanspaceagency"),
  E("ROCKET LAB", "science", "aa", "American-New Zealand launch company founded by Peter Beck in 2006, whose Electron became one of the most frequently flown small rockets. Now developing the larger reusable Neutron launcher.", "Pathfinder via Ambition Architecture. Rocket Lab built dependable, repeatable access to space, the unshowy architecture that turns orbital ambition into routine, scheduled reality.", "https://www.rocketlabusa.com", "Rocket Lab", "rocketlab"),
  E("AXIOM SPACE", "science", "aa", "American company founded in 2016, building the first commercial space station to succeed the ISS, and flying private astronaut missions to open up access to low Earth orbit.", "Pathfinder via Ambition Architecture. Axiom is building the first commercial space station, the literal architecture for living and working in orbit once the agencies step back.", "https://www.axiomspace.com", "Axiom Space", "axiom.space"),
  E("RELATIVITY SPACE", "science", "aa", "Los Angeles launch company founded in 2015 and known for 3D printing the majority of its rockets. Flew Terran 1, the first largely 3D-printed rocket, in 2023 and is developing the reusable Terran R.", "Pathfinder via Ambition Architecture. Relativity is rethinking how rockets are made at the factory level, building the manufacturing architecture for a multiplanetary future rather than just the rockets.", "https://www.relativityspace.com", "Relativity Space", "relativityspace"),
  E("STOKE SPACE", "science", "aa", "Seattle-area launch company founded in 2020 by Blue Origin and SpaceX veterans, developing Nova, a rocket designed to be fully and rapidly reusable from first stage to second.", "Pathfinder via Ambition Architecture. Stoke is engineering full reusability from first principles, building the foundational architecture that could make reaching orbit genuinely cheap.", "https://www.stokespace.com", "Stoke Space", "stokespace"),
  E("VARDA", "science", "aa", "Californian company founded in 2021 to manufacture pharmaceuticals in microgravity and return them to Earth in re-entry capsules. Has completed its first in-space drug processing missions.", "Pathfinder via Ambition Architecture. Varda is building the infrastructure to manufacture in orbit, the architecture for an entire new industry that does not yet exist on the ground.", "https://www.varda.com", "Varda Space Industries", "vardaspace"),
  E("MSF", "science", "oi", "Mu00e9decins Sans Frontiu00e8res, the international humanitarian medical organisation founded in Paris in 1971. Delivers emergency care in conflict zones, epidemics and disasters, and was awarded the Nobel Peace Prize in 1999.", "Pathfinder via The Optimism Imperative. MSF embodies optimism as agency, showing up where others have given up and refusing to accept suffering as inevitable, the disciplined belief that the world can be made better turned into action.", "https://www.msf.org", "Médecins Sans Frontières", "msf_international"),
  E("BIONTECH", "science", "aa", "German biotechnology company founded in Mainz in 2008, which developed the first approved mRNA vaccine with Pfizer during the COVID-19 pandemic. Now focused on mRNA-based cancer immunotherapies.", "Pathfinder via Ambition Architecture. BioNTech spent years building the mRNA platform before the world needed it, foundational architecture for medicine that turned patient principle into global impact.", "https://www.biontech.com", "BioNTech", "biontech_group"),
  E("ISOMORPHIC LABS", "science", "aa", "London drug discovery company spun out of DeepMind in 2021, applying AlphaFold-derived AI to the design of new medicines. Led by DeepMind co-founder Demis Hassabis.", "Pathfinder via Ambition Architecture. Isomorphic is building the architecture to design medicines with AI, codifying the structure that could turn drug discovery from art into engineering.", "https://www.isomorphiclabs.com", "Isomorphic Labs", "isomorphiclabs"),
  E("NEURALINK", "science", "dt", "American neurotechnology company founded by Elon Musk in 2016, developing implantable brain-computer interfaces. Began first-in-human trials of its implant in 2024.", "Pathfinder via Deep Time Thinking. Merging mind and machine is a civilisational bet rather than a near-term one, and Neuralink is building toward a future for human cognition that will unfold across generations.", "https://neuralink.com", "Neuralink", "neuralink"),
  E("CRISPR THERAPEUTICS", "science", "aa", "Swiss-American gene-editing company co-founded by Nobel laureate Emmanuelle Charpentier. Its therapy Casgevy, approved in 2023 for sickle cell disease, was the first CRISPR-based medicine to reach patients.", "Pathfinder via Ambition Architecture. CRISPR Therapeutics is turning a foundational tool for editing life into structured, approvable medicine, ambition made into a repeatable architecture.", "https://www.crisprtx.com", "CRISPR Therapeutics", "crisprtx"),
  E("RECURSION", "science", "aa", "Salt Lake City biotechnology company founded in 2013, using automated experiments and machine learning to map cellular biology and discover drugs at industrial scale.", "Pathfinder via Ambition Architecture. Recursion built an industrial platform for biology, the architecture that turns drug discovery into something systematic, scalable and repeatable.", "https://www.recursion.com", "Recursion Pharmaceuticals", "recursionpharma"),
  E("MODERNA", "science", "aa", "American biotechnology company founded in 2010, a pioneer of messenger RNA medicine and maker of one of the principal COVID-19 vaccines. Developing mRNA treatments for cancer, flu and rare disease.", "Pathfinder via Ambition Architecture. Moderna treated mRNA as a platform rather than a product, foundational architecture for a new kind of medicine that can be pointed at problem after problem.", "https://www.modernatx.com", "Moderna", "moderna_tx"),
  E("COLOSSAL", "science", "oi", "Texas biosciences company founded in 2021, applying gene editing to de-extinction projects including the woolly mammoth, thylacine and dodo, alongside conservation biotechnology for endangered species.", "Pathfinder via The Optimism Imperative. Colossal answers ecological grief with audacity, choosing to restore what was lost rather than mourn it, a defiantly hopeful vision of a wilder future.", "https://colossal.com", "Colossal Biosciences", "colossal"),
  E("PATAGONIA", "culture", "gl", "American outdoor clothing company founded by Yvon Chouinard in 1973. In 2022 ownership was transferred to a trust and non-profit so that all profits fund climate action, with Earth described as the company's only shareholder.", "Pathfinder via Gravitational Leadership. Patagonia built a world rather than a campaign, and its refusal to bend on what it stands for turned a clothing company into a gravitational force that imitation only makes more singular.", "https://www.patagonia.com", "Patagonia, Inc.", "patagonia"),
  E("COMMONWEALTH FUSION", "science", "dt", "MIT spin-out founded in 2018, building SPARC, a compact tokamak intended to demonstrate net-energy fusion. Backed by some of the largest private investment in fusion energy.", "Pathfinder via Deep Time Thinking. Fusion is the ultimate long horizon, the energy source of the next century, and Commonwealth is doing the patient work of building it before the market is ready to reward it.", "https://cfs.energy", "Commonwealth Fusion Systems", "cfs_energy"),
  E("THE OCEAN CLEANUP", "science", "oi", "Dutch non-profit founded by Boyan Slat in 2013, developing systems to remove plastic from the Great Pacific Garbage Patch and to intercept it in rivers before it reaches the sea.", "Pathfinder via The Optimism Imperative. The Ocean Cleanup refuses to accept a ruined ocean as the price of progress, building real machines toward a visibly better future, optimism made tangible.", "https://theoceancleanup.com", "The Ocean Cleanup", "theoceancleanup"),
  E("ØRSTED", "science", "oi", "Danish energy company, formerly the oil and gas firm DONG Energy, which transformed itself into the world's largest developer of offshore wind power.", "Pathfinder via The Optimism Imperative. Ørsted reinvented itself from fossil fuels to offshore wind, living proof that even the heaviest legacy can choose a positive future and build it.", "https://orsted.com", "Ørsted (company)", "orsted"),
  E("CLIMEWORKS", "science", "oi", "Swiss company founded in 2009, operating the world's first commercial direct air capture plants in Iceland, which remove carbon dioxide from the atmosphere for permanent storage underground.", "Pathfinder via The Optimism Imperative. Climeworks insists the carbon story can still be rewritten, pulling CO2 from the air as an act of defiant, engineered optimism about the planet's future.", "https://climeworks.com", "Climeworks", "climeworks"),
  E("FORM ENERGY", "science", "oi", "American battery company founded in 2017, developing iron-air batteries that can store energy for several days at a time, aimed at making renewable electricity grids reliable.", "Pathfinder via The Optimism Imperative. Form Energy is building the long-duration storage that makes a fully renewable grid believable, the unshowy engineering behind a genuinely hopeful energy future.", "https://formenergy.com", "Form Energy", "formenergy"),
  E("TESLA", "science", "oi", "American electric vehicle and energy company led by Elon Musk, which brought EVs to the mass market and builds grid-scale battery storage and solar products.", "Pathfinder via The Optimism Imperative. Tesla made the clean future desirable rather than dutiful, accelerating the energy transition by proving that optimism about the planet could also be aspirational.", "https://www.tesla.com", "Tesla, Inc.", "tesla"),
  E("HELION", "science", "dt", "Washington-state fusion company founded in 2013, developing a pulsed fusion generator. Holds a power purchase agreement with Microsoft, the first of its kind for fusion electricity.", "Pathfinder via Deep Time Thinking. Helion is racing toward limitless clean energy on a timescale most investors cannot stomach, a bet whose payoff is measured in the transformation of civilisation itself.", "https://www.helionenergy.com", "Helion Energy", "helionenergy"),
  E("WOLFRAM RESEARCH", "science", "gl", "American computational software company founded by Stephen Wolfram in 1987, creator of Mathematica and the Wolfram Language, and home to the Wolfram Physics Project, which explores emergence and complexity from simple computational rules.", "Pathfinder via Gravitational Leadership. Wolfram built his own field rather than compete inside anyone else's, staying independent for four decades so that one mind's singular theory of everything could pull the whole of physics toward it.", "https://www.wolfram.com", "Wolfram Research", "wolframresearch"),
  E("ECOSIA", "science", "oi", "Berlin-based search engine founded in 2009 that uses its advertising profits to fund tree planting, with more than 200 million trees planted across the world to date.", "Pathfinder via The Optimism Imperative. Ecosia turned an everyday action into reforestation, a quietly defiant insistence that the tools we already use can be redirected toward a better future.", "https://www.ecosia.org", "Ecosia", "ecosia"),
  E("CERN", "science", "dt", "The European Organization for Nuclear Research, founded in 1954 near Geneva, operates the Large Hadron Collider, where the Higgs boson was discovered in 2012. The World Wide Web was invented there in 1989.", "Pathfinder via Deep Time Thinking. CERN exists to answer questions about the fundamental nature of reality, the slowest and deepest science there is, building instruments and collaborations designed to outlast nations.", "https://home.cern", "CERN", "cern"),
  E("LONG NOW FOUNDATION", "science", "dt", "San Francisco foundation established in 1996 to foster long-term thinking. Best known for building a monumental clock inside a Texas mountain, designed to keep time for 10,000 years.", "Pathfinder via Deep Time Thinking. The Long Now is deep time made literal, championing a ten thousand year perspective as the antidote to short-termism and asking every institution to lengthen the horizon it plans against.", "https://longnow.org", "Long Now Foundation", "longnow"),
  E("ITER", "science", "dt", "International fusion megaproject under construction in southern France, in which 35 nations are collaborating to build the world's largest tokamak and demonstrate fusion power at industrial scale.", "Pathfinder via Deep Time Thinking. ITER is a multi-decade, multi-nation wager on fusion, proof that humanity can still cooperate on a timescale longer than any single government or career.", "https://www.iter.org", "ITER", "iterorganization"),
  E("ARC INSTITUTE", "science", "dt", "Palo Alto research institute founded in 2021 in partnership with Stanford, Berkeley and UCSF, giving scientists long-term core funding to pursue curiosity-driven biomedical research.", "Pathfinder via Deep Time Thinking. Arc backs scientists to chase the hardest problems in biology over years rather than grant cycles, betting that real breakthroughs come to those who think in decades.", "https://arcinstitute.org", "Arc Institute", "arcinstitute"),
  E("ALLEN INSTITUTE", "science", "dt", "Seattle non-profit research institute founded by Paul Allen in 2003, producing open atlases of the brain, the cell and the immune system that are shared freely with science.", "Pathfinder via Deep Time Thinking. The Allen Institute treats understanding the brain as a generational endeavour, building open foundational science that will be drawn on long after its founders are gone.", "https://alleninstitute.org", "Allen Institute", "alleninstitute"),
  E("SANTA FE INSTITUTE", "science", "dt", "Independent New Mexico research institute founded in 1984 and the home of complexity science, studying common patterns across physical, biological and social systems.", "Pathfinder via Deep Time Thinking. Santa Fe studies the deep patterns beneath complex systems, the kind of fundamental understanding that compounds slowly and reshapes how we see the world over decades.", "https://www.santafe.edu", "Santa Fe Institute", "santafeinstitute"),
  E("MIT MEDIA LAB", "science", "aa", "Interdisciplinary research laboratory at MIT, founded in 1985 and known for work spanning wearable computing, learning technology, robotics and digital interfaces.", "Pathfinder via Ambition Architecture. The Media Lab is a structure built to invent the future across disciplines, the architecture that turns wild ambition into working prototypes.", "https://www.media.mit.edu", "MIT Media Lab", "mitmedialab"),
  E("FRANCIS CRICK INSTITUTE", "science", "dt", "Europe's largest biomedical laboratory under one roof, opened in London in 2016, where more than 2,000 scientists study the biology of health and disease.", "Pathfinder via Deep Time Thinking. The Crick pursues the long, patient science of how life works, the foundational biology whose payoff arrives in medicine decades downstream.", "https://www.crick.ac.uk", "Francis Crick Institute", "thecrick"),
  E("MAX PLANCK SOCIETY", "science", "dt", "Germany's network of more than 80 basic research institutes, whose scientists have won dozens of Nobel Prizes for work spanning gravitational waves to ancient DNA.", "Pathfinder via Deep Time Thinking. Max Planck has championed curiosity-driven fundamental research for over a century, proof that the most important science is a multigenerational commitment rather than a quarterly return.", "https://www.mpg.de", "Max Planck Society", "maxplanckgesellschaft"),
  E("BROAD INSTITUTE", "science", "dt", "Genomic research institute of MIT and Harvard founded in 2004, a leader in CRISPR gene editing and in sharing large-scale genomic data openly for medicine.", "Pathfinder via Deep Time Thinking. The Broad treats the genome as a resource for all of humanity, building open foundational tools whose value will compound across generations of medicine.", "https://www.broadinstitute.org", "Broad Institute", "broadinstitute"),
  E("ALAN TURING INSTITUTE", "science", "dt", "The UK's national institute for data science and artificial intelligence, founded in 2015 and named after the founder of computer science.", "Pathfinder via Deep Time Thinking. Named for the man who imagined computing decades before it existed, the Turing Institute holds the long view on data science and AI as forces that will shape society for generations.", "https://www.turing.ac.uk", "Alan Turing Institute", "theturinginst"),
  E("SETI INSTITUTE", "science", "dt", "Californian research institute founded in 1984, searching for life and intelligence beyond Earth with radio telescopes, AI and planetary science.", "Pathfinder via Deep Time Thinking. Few questions are deeper or more patient than whether we are alone, and SETI listens across cosmic timescales, holding a perspective that dwarfs any human lifespan.", "https://www.seti.org", "SETI Institute", "setiinstitute"),
  E("ROYAL INSTITUTION", "science", "cg", "London home of science communication since 1799, where Faraday lectured and ten chemical elements were discovered, and whose Christmas Lectures have run since 1825.", "Pathfinder via The Culture Grid. For two centuries the Royal Institution has been infrastructure for scientific wonder, taking discovery out of the lab and letting it flow to the public, the original grid for ideas.", "https://www.rigb.org", "Royal Institution", "ri_science"),
  E("PERIMETER INSTITUTE", "science", "dt", "Independent Canadian centre for theoretical physics founded in 1999, probing quantum gravity and the foundations of the universe while sharing its training freely online.", "Pathfinder via Deep Time Thinking. Perimeter chases the deepest questions in theoretical physics, the kind whose answers may take generations to arrive and centuries to apply.", "https://perimeterinstitute.ca", "Perimeter Institute", "perimeterinstitute"),
  E("TATE MODERN", "culture", "cg", "Britain's national museum of modern and contemporary art, opened in a converted Bankside power station in 2000 and consistently among the most visited art museums in the world.", "Pathfinder via The Culture Grid. Tate Modern is cultural infrastructure on a civic scale, a free and open conduit that lets contemporary art flow to millions rather than the few.", "https://www.tate.org.uk", "Tate Modern", "tate"),
  E("TEAMLAB", "art", "gl", "Tokyo art collective founded in 2001, creating immersive digital installations and the permanent Borderless and Planets museums, which draw millions of visitors a year.", "Pathfinder via Gravitational Leadership. teamLab does not advertise, it draws pilgrims, the sheer depth and originality of its immersive worlds creating a field of attraction that pulls millions toward something they have never seen.", "https://www.teamlab.art", "TeamLab (art collective)", "teamlab.official"),
  E("A24", "art", "gl", "Independent New York film studio founded in 2012, producer and distributor of Moonlight, Everything Everywhere All at Once and Past Lives, and winner of multiple Best Picture Oscars.", "Pathfinder via Gravitational Leadership. A24 became gravitational by trusting taste over formula, building a brand so clear that audiences now follow the logo itself, proof that conviction outperforms chasing the market.", "https://a24films.com", "A24", "a24"),
  E("MOMA", "culture", "cg", "The Museum of Modern Art in New York, founded in 1929, holds one of the most influential collections of modern and contemporary art in the world.", "Pathfinder via The Culture Grid. MoMA built the grid for modern art, shaping how the world understands it and keeping that conversation flowing across generations.", "https://www.moma.org", "Museum of Modern Art", "themuseumofmodernart"),
  E("V&A", "culture", "cg", "London's Victoria and Albert Museum, founded in 1852, is the world's largest museum of applied arts, decorative arts and design, with a collection spanning 5,000 years.", "Pathfinder via The Culture Grid. The V&A is a vast, generous conduit for design and creativity, infrastructure that lets the story of human making flow to everyone who walks in.", "https://www.vam.ac.uk", "Victoria and Albert Museum", "vamuseum"),
  E("SERPENTINE", "culture", "cg", "Pair of contemporary art galleries in London's Kensington Gardens, known for free exhibitions, a pioneering arts and technology programme and the annual Serpentine Pavilion architecture commission.", "Pathfinder via The Culture Grid. The Serpentine powers the flow of new ideas in art and architecture, a small institution that punches far above its weight as a conductor of culture.", "https://www.serpentinegalleries.org", "Serpentine Galleries", "serpentineuk"),
  E("FACTORY INTERNATIONAL", "culture", "cg", "Manchester arts organisation behind the Manchester International Festival and Aviva Studios, a landmark venue for commissioning new work that opened in 2023.", "Pathfinder via The Culture Grid. Factory International built a permanent home for ambitious culture in Manchester, infrastructure designed to let artists and audiences connect at a scale the city never had.", "https://factoryinternational.org", "Factory International", "factoryintl"),
  E("GLASTONBURY", "culture", "cg", "The world's largest greenfield music and performing arts festival, held on a Somerset farm since 1970 and run by the Eavis family, with long-standing environmental commitments.", "Pathfinder via The Culture Grid. Glastonbury is less a festival than a temporary city for culture, the grid through which a generation's music, ideas and values flow for one weekend a year.", "https://www.glastonburyfestivals.co.uk", "Glastonbury Festival", "glastonburyofficial"),
  E("PALACE", "culture", "gl", "London skateboard and clothing brand founded in 2009 by Lev Tanju, which grew from a skate crew into one of streetwear's most influential labels while remaining independent.", "Pathfinder via Gravitational Leadership. Palace never explains itself, it just builds its own world with total creative sovereignty, and that refusal to court anyone is exactly what makes it irresistible.", "https://www.palaceskateboards.com", "Palace Skateboards", "palaceskateboards"),
  E("BARBICAN", "culture", "cg", "Europe's largest multi-arts centre, opened in the City of London in 1982 within a celebrated Brutalist estate, housing concert halls, theatres, cinemas, galleries and a conservatory.", "Pathfinder via The Culture Grid. The Barbican is a cathedral of culture under one roof, infrastructure that lets art, music, film and ideas cross-pollinate and flow to the public.", "https://www.barbican.org.uk", "Barbican Centre", "barbicancentre"),
  E("MEOW WOLF", "art", "gl", "American arts company that began as a Santa Fe collective in 2008, building permanent immersive art installations such as House of Eternal Return. Structured as a certified B Corporation.", "Pathfinder via Gravitational Leadership. Meow Wolf turned uncompromising artistic vision into places people travel for, becoming gravitational not by reaching outward but by building something so singular it pulls people in.", "https://meowwolf.com", "Meow Wolf", "meowwolf"),
  E("REFIK ANADOL", "art", "gl", "Turkish-American media artist who turns vast datasets into living architectural canvases, and whose work Unsupervised filled MoMA's lobby with machine dreams of its own collection.", "Pathfinder via Gravitational Leadership. Refik Anadol made data into the sublime and owns that territory entirely, a depth of mastery so distinctive that the whole field of AI art now orbits his work.", "https://refikanadol.com", "Refik Anadol", "refikanadol"),
  E("RANDOM INTERNATIONAL", "art", "gl", "London art collective best known for Rain Room, an indoor downpour that pauses wherever a visitor walks, exploring instinct, simulation and collective behaviour.", "Pathfinder via Gravitational Leadership. Random International built a language of their own at the meeting point of art and engineering, and that singular mastery is what makes the world come to them.", "https://www.random-international.com", "Random International", "random_international"),
  E("MARSHMALLOW LASER FEAST", "art", "gl", "London experiential art collective using virtual reality and breath-tracking to let audiences experience forests, oceans and the inside of the body.", "Pathfinder via Gravitational Leadership. Marshmallow Laser Feast turned deep technical craft into wonder, becoming gravitational by making experiences so original that nobody can quite imitate them.", "https://www.marshmallowlaserfeast.com", "Marshmallow Laser Feast", "marshmallowlaserfeast"),
  E("SOMERSET HOUSE", "culture", "cg", "Neoclassical London landmark turned creative community, home to hundreds of resident artists and makers, Somerset House Studios and a courtyard of fountains, film and ice.", "Pathfinder via The Culture Grid. Somerset House turned a historic building into a living hub for the creative industries, infrastructure where culture is made and shared rather than merely displayed.", "https://www.somersethouse.org.uk", "Somerset House", "somersethouse"),
  E("BOILER ROOM", "culture", "cg", "Hackney-based collective broadcasting DJ sets and live music from around the world since 2010, a platform that democratised access to electronic and experimental music.", "Pathfinder via The Culture Grid. Boiler Room rewired club culture into a global grid, letting underground scenes flow to anyone anywhere and connecting communities that would never otherwise meet.", "https://boilerroom.tv", "Boiler Room (collective)", "boilerroom"),
  E("WARP RECORDS", "culture", "cg", "Independent label born in Sheffield in 1989, home to Aphex Twin, Boards of Canada and Autechre, which defined the sound of electronic listening music.", "Pathfinder via The Culture Grid. Warp is infrastructure for the future of music, a label that gives the most adventurous artists somewhere to go and lets their ideas flow into the wider culture.", "https://warp.net", "Warp (record label)", "warprecords"),
  E("NINJA TUNE", "culture", "cg", "Independent London label founded by Coldcut in 1990, an early leader on sustainability in music with a solar-powered headquarters and support for the Music Climate Pact.", "Pathfinder via The Culture Grid. Ninja Tune has spent decades as a conduit for independent music, a label that powers the flow of new sound rather than chasing the centre.", "https://ninjatune.net", "Ninja Tune", "ninjatune"),
  E("NTS RADIO", "culture", "cg", "Independent online radio station founded in Hackney in 2011, broadcasting from London, Manchester, Los Angeles and Shanghai with thousands of resident hosts and no playlists.", "Pathfinder via The Culture Grid. NTS is a global grid for music discovery, an open platform that connects scenes and selectors across the world and keeps culture moving.", "https://www.nts.live", "NTS Radio", "nts_radio"),
  E("BANDCAMP", "culture", "cg", "Online music platform founded in 2008 where fans buy directly from artists, paying out the large majority of every sale; its Bandcamp Fridays have channelled hundreds of millions of dollars to musicians.", "Pathfinder via The Culture Grid. Bandcamp built the fairest pipe between artists and listeners, infrastructure that lets musicians thrive on their own terms and culture flow without a gatekeeper taking the current.", "https://bandcamp.com", "Bandcamp", "bandcamp"),
  E("APPLE", "art", "gl", "American technology company founded in 1976, maker of the iPhone and Mac and the company that defined modern consumer hardware design. Aims for carbon neutrality across all its products by 2030.", "Pathfinder via Gravitational Leadership. Apple never chases attention, it commands it, decades of refusing to compromise on the meeting of art and technology building a field of attraction so strong the industry orbits it.", "https://www.apple.com", "Apple Inc.", "apple"),
  E("TEENAGE ENGINEERING", "art", "gl", "Swedish electronics company founded in Stockholm in 2007, designing playful audio hardware such as the OP-1 synthesiser and collaborating with brands from IKEA to Nothing.", "Pathfinder via Gravitational Leadership. Teenage Engineering answers to nobody but its own taste, and that creative sovereignty, executed with obsessive craft, is precisely what makes its work magnetic.", "https://teenage.engineering", "Teenage Engineering", "teenageengineering"),
  E("IKEA", "art", "gl", "Swedish furniture retailer founded by Ingvar Kamprad in 1943, whose flat-pack democratic design made good furniture affordable worldwide. Investing heavily in circular and renewable operations.", "Pathfinder via Gravitational Leadership. IKEA made considered design gravitational at planetary scale, building a world so coherent and so clearly its own that it became the default rather than a competitor.", "https://www.ikea.com", "IKEA", "ikea"),
  E("ABLETON", "art", "aa", "Berlin music software company founded in 1999 by musicians, maker of Ableton Live, a digital audio workstation built for performance as much as production, and the Push instrument.", "Pathfinder via Ambition Architecture. Ableton built the foundational architecture of modern music-making, the structure beneath countless artists' ambition rather than just another instrument.", "https://www.ableton.com", "Ableton", "ableton"),
  E("IDEO", "art", "aa", "Global design consultancy formed in Palo Alto in 1991, which popularised design thinking and human-centred design across products, services and organisations.", "Pathfinder via Ambition Architecture. IDEO codified human-centred design into a method the world could use, turning a way of thinking into durable architecture for how things get made.", "https://www.ideo.com", "IDEO", "ideo"),
  E("MUJI", "art", "gl", "Japanese retailer founded in 1980 around the idea of no-brand quality goods, selling simple, functional products with an ethos of sufficiency and restraint.", "Pathfinder via Gravitational Leadership. Muji championed the quiet power of restraint, a philosophy so disciplined and complete that it became a category of one, pulling people toward less rather than more.", "https://www.muji.com", "Muji", "muji_global"),
  E("PENTAGRAM", "art", "gl", "The world's largest independent design consultancy, founded in London in 1972 and owned entirely by its partners, who each lead their own creative teams.", "Pathfinder via Gravitational Leadership. Pentagram earns its pull through sheer depth of craft, an independent partnership whose mastery is so respected that the work speaks long before the pitch begins.", "https://www.pentagram.com", "Pentagram (design firm)", "pentagramdesign"),
  E("NOTHING", "art", "gl", "London consumer technology company founded by Carl Pei in 2020, building smartphones and earbuds with a distinctive transparent design language.", "Pathfinder via Gravitational Leadership. Nothing built desire from clarity of vision rather than spec sheets, proving that a young brand can become gravitational simply by knowing exactly what it stands for.", "https://nothing.tech", "Nothing (company)", "nothing"),
  E("FRAMEWORK", "science", "aa", "San Francisco company founded in 2019, making modular laptops designed to be repaired and upgraded by their owners, a working proof of the right-to-repair movement.", "Pathfinder via Ambition Architecture. Framework rebuilt the laptop around principle, an architecture of repairability and longevity that turns a belief about better technology into something you can actually buy.", "https://frame.work", "Framework Computer", "frameworkcomputer"),
  E("IONQ", "science", "aa", "American quantum computing company founded in 2015 from University of Maryland and Duke research, building trapped-ion quantum computers accessible through the major cloud platforms.", "Pathfinder via Ambition Architecture. IonQ is building the foundational hardware for quantum computing, the architecture beneath a technology that could reshape what computation can do.", "https://ionq.com", "IonQ", "ionq_inc"),
  E("FAIRPHONE", "science", "oi", "Dutch social enterprise founded in 2013, making modular, repairable smartphones with fairly sourced materials and transparent supply chains.", "Pathfinder via The Optimism Imperative. Fairphone refuses the throwaway logic of its own industry, building ethical, repairable technology as a hopeful argument that things can be made the right way.", "https://www.fairphone.com", "Fairphone", "fairphone"),
  E("TERRAFORMATION", "science", "oi", "American startup founded by Kohala Center veteran Yishan Wong in 2020, building tools and seed banks to accelerate global reforestation as a scalable, natural solution to climate change.", "Pathfinder via The Optimism Imperative. Terraformation treats the climate fight as winnable, scaling forests as a defiantly optimistic answer to a problem most people find paralysing.", "https://www.terraformation.com", "Terraformation", "terraformation"),
  E("WIKIPEDIA", "culture", "cg", "The free encyclopaedia, launched in 2001 and written collaboratively by volunteers, now spanning tens of millions of articles in more than 300 languages. Operated by the non-profit Wikimedia Foundation.", "Pathfinder via The Culture Grid. Wikipedia is pure grid, existing to let human knowledge flow freely between people, owned by no one and powering everyone, the closest thing the internet has to public infrastructure for ideas.", "https://www.wikipedia.org", "Wikipedia", "wikipedia"),
  E("RASPBERRY PI", "culture", "aa", "Cambridge-based charity founded in 2008 to put affordable computing into young people's hands. Its tiny single-board computers have sold in the tens of millions worldwide.", "Pathfinder via Ambition Architecture. Raspberry Pi built the architecture of access, a tiny, affordable structure that put the power to build and learn into millions of hands.", "https://www.raspberrypi.org", "Raspberry Pi Foundation", "raspberrypi"),
  E("EDEN PROJECT", "culture", "oi", "Cornish educational charity built in a former clay pit, whose giant biomes house the world's largest indoor rainforest and teach regeneration at scale.", "Pathfinder via The Optimism Imperative. The Eden Project turned an exhausted clay pit into a celebration of what is possible, a living, Solarpunk argument that humanity and nature can flourish together.", "https://www.edenproject.com", "Eden Project", "edenproject"),
  E("BREAKTHROUGH ENERGY", "science", "oi", "Network founded by Bill Gates in 2015, investing patient capital in early-stage climate technologies, from fusion and long-duration batteries to green steel and sustainable aviation fuel.", "Pathfinder via The Optimism Imperative. Breakthrough Energy backs the technologies that make a zero-carbon future credible, capital deployed as an act of disciplined optimism about what we can still build.", "https://www.breakthroughenergy.org", "Breakthrough Energy", "breakthroughenergy"),
  E("SNØHETTA", "art", "oi", "Norwegian architecture studio behind the Oslo Opera House and the Powerhouse series of energy-positive buildings, which produce more energy than they consume over their lifetime.", "Pathfinder via The Optimism Imperative. Snøhetta designs buildings that give back more than they take, a practice rooted in the belief that architecture can model a more generous future.", "https://www.snohetta.com", "Snøhetta", "snohetta"),
  E("BJARKE INGELS GROUP", "art", "oi", "Copenhagen and New York architecture practice founded by Bjarke Ingels, whose CopenHill power plant doubles as a ski slope and whose Masterplanet project imagines a sustainable redesign of Earth.", "Pathfinder via The Optimism Imperative. BIG champions the idea that the sustainable future can also be joyful, dramatising optimism into buildings that make a better world feel desirable rather than dour.", "https://big.dk", "Bjarke Ingels Group", "big_builds"),
  E("STUDIO ROOSEGAARDE", "art", "oi", "Dutch social design lab founded by Daan Roosegaarde, building landscapes of the future that merge technology and nature, from smog-eating towers to luminous solar fields.", "Pathfinder via The Optimism Imperative. Studio Roosegaarde is Solarpunk made real, designing dreamscapes that insist technology and nature can combine into a future worth wanting.", "https://www.studioroosegaarde.net", "Daan Roosegaarde", "studioroosegaarde"),
  E("STONE ISLAND", "art", "gl", "Italian clothing company founded in 1982, renowned for pioneering garment dyeing and material research, with an archive of hundreds of experimental fabrics that made it a cult name in design and menswear.", "Pathfinder via Gravitational Leadership. Stone Island turned obsessive material research into a cult, a depth of mastery so real that devotion to the badge needs no marketing at all.", "https://www.stoneisland.com", "Stone Island", "stoneisland_official"),
  E("NEXUS STUDIOS", "art", "gl", "London and Los Angeles animation and innovation studio founded in 2000, creating award-winning films, immersive experiences and augmented reality for brands including Apple, Google and Nike.", "Pathfinder via Gravitational Leadership. Nexus draws the world's most ambitious creative work through the depth of its craft, a studio whose mastery is its own form of gravity.", "https://nexusstudios.com", "Nexus Studios", "nexusstudios"),
  E("ROLAND", "art", "gl", "Japanese electronic instrument company founded in 1972, whose TR-808 drum machine, TB-303 and synthesizers defined the sound of hip-hop, techno and house, shaping modern music for half a century.", "Pathfinder via Gravitational Leadership. Roland's instruments did not chase trends, they defined the sound of entire genres, a mastery so foundational that culture keeps returning to it decades on.", "https://www.roland.com", "Roland Corporation", "roland_global"),
  E("UNITED VISUAL ARTISTS", "art", "gl", "London art and design studio founded by Matt Clark in 2003, producing large-scale light sculptures and installations that explore perception, time and natural phenomena.", "Pathfinder via Gravitational Leadership. UVA built a singular language of light and space through deep technical command, work so distinctive that it pulls collaborators and audiences into its orbit.", "https://uva.co.uk", "United Visual Artists", "uva_london"),
  E("RYOJI IKEDA", "art", "gl", "Japanese media artist working with light, sound and data, whose Datamatics project visualises the sublime in terabytes, and whose installations turn mathematics into sensory experience.", "Pathfinder via Gravitational Leadership. Ikeda goes deeper into data and sound than anyone, with total creative sovereignty, and that uncompromising depth is exactly what makes his work gravitational.", "https://www.ryoji-ikeda.com", "Ryoji Ikeda", "ryojiikeda"),
  E("SUPERBLUE", "art", "aa", "American enterprise founded by Pace Gallery in 2020, building large-format experiential art centres where audiences step inside the work of artists such as teamLab.", "Pathfinder via Ambition Architecture. Superblue built a new structure for experiential art to exist and sustain itself, the architecture that turns ambitious immersive work into something the public can reach.", "https://www.superblue.com", "Superblue", "superblue"),
  E("NAOSHIMA", "art", "gl", "Japanese island in the Seto Inland Sea reborn as a contemporary art destination through the Benesse Art Site, home to Tadao Ando museums and works by James Turrell and Yayoi Kusama.", "Pathfinder via Gravitational Leadership. Naoshima turned a remote island into a place people cross the world to reach, gravitational not through promotion but through the sheer conviction of its vision.", "https://benesse-artsite.jp", "Naoshima", "benesse_artsite"),
  E("SÓNAR", "culture", "cg", "Barcelona festival of advanced music and creative technology, held since 1994, pairing club culture with a congress on art, science and the future.", "Pathfinder via The Culture Grid. Sónar is the meeting point where music, art and technology flow together, infrastructure for the conversation about where culture and the future collide.", "https://sonar.es", "Sónar", "sonarfestival"),
  E("MUTEK", "culture", "cg", "Montreal festival founded in 2000, dedicated to electronic music and digital creativity, with sister editions across the Americas, Europe and Asia.", "Pathfinder via The Culture Grid. MUTEK connects the global community of digital creativity, a conduit that lets electronic music and audiovisual art flow across borders.", "https://mutek.org", "Mutek", "mutek_hq"),
  E("NXT MUSEUM", "culture", "cg", "Amsterdam museum opened in 2020, the first in the Netherlands devoted to new media art, presenting large-scale digital and sensory installations.", "Pathfinder via The Culture Grid. Nxt Museum built a permanent home for new media art, infrastructure that lets a new generation of digital culture reach the public.", "https://nxtmuseum.com", "Nxt Museum", "nxtmuseum"),
  E("DESIGN MUSEUM", "culture", "cg", "London museum of contemporary design and architecture, relocated to Kensington in 2016, whose exhibitions and Designer of the Year award shape design discourse.", "Pathfinder via The Culture Grid. The Design Museum is a conduit for understanding the designed world, infrastructure that lets the ideas shaping our lives flow to everyone.", "https://designmuseum.org", "Design Museum", "designmuseum"),
  E("180 STUDIOS", "culture", "cg", "London cultural space on the Strand presenting ambitious digital art and design exhibitions, from immersive light and sound to major surveys of new media.", "Pathfinder via The Culture Grid. 180 Studios turned a Brutalist landmark into a stage for boundary-pushing digital art, infrastructure that channels the most ambitious new culture to the public.", "https://180studios.com", "180 The Strand", "180studios"),
  E("ZKM", "culture", "cg", "German Centre for Art and Media in Karlsruhe, founded in 1989, a leading museum and research institution at the meeting point of art, science and digital technology.", "Pathfinder via The Culture Grid. ZKM has spent decades as infrastructure for art and technology, a conduit that lets the conversation between the two flow and endure.", "https://zkm.de", "ZKM Center for Art and Media", "zkmkarlsruhe"),
  E("VOLLEBAK", "art", "oi", "British clothing company founded in 2015 by twin brothers, making experimental garments from advanced materials like graphene, ceramic and biodegradable fibres, designed around science, survival and the far future.", "Pathfinder via The Optimism Imperative. Vollebak explores the future for the sheer love of it, treating clothing as a canvas for optimism about science, materials and what comes next.", "https://vollebak.com", "Vollebak", "vollebak"),
  E("AEON", "culture", "cg", "London digital magazine publishing long-form essays and beautifully-produced videos on science, philosophy, psychology and ideas, with a visual design and editorial rigour that treats complex thinking as an art form.", "Pathfinder via The Culture Grid. Aeon treats deep ideas as something to be shared widely and well, a quiet but vital piece of infrastructure for serious thinking in a noisy world.", "https://aeon.co", "Aeon (magazine)", "aeonmag"),
];
    ...
    <div className="pf-card-backdrop" onClick={onClose}>
      ...
      >
        ...
        <div className="pf-card-body">
          ...
          <p className="pf-card-pov">{entry.desc}</p>
          {entry.pov && <p className="pf-card-note">{entry.pov}</p>}
...
.pf-card {
  width: 100%; max-width: 680px; max-height: calc(100% - 16px);
...
.pf-card-body { padding: 22px 22px 26px; overflow-y: auto; user-select: text; -webkit-user-select: text; }
